    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_public', models.BooleanField(default=False, verbose_name='그룹 공개 여부')),
                ('invite_code', models.CharField(default=None, max_length=5, validators=[django.core.validators.MinLengthValidator(5)], verbose_name='그룹 초대 코드')),
